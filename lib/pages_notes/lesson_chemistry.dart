...
class lessonChemistry extends StatefulWidget {
  @override
  _lessonChemistryState createState() => _lessonChemistryState();
}

class _lessonChemistryState extends State<lessonChemistry> {
  @override
