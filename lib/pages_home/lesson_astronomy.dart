...
class lessonAstronomy extends StatefulWidget {
  @override
  _lessonAstronomyState createState() => _lessonAstronomyState();
}

class _lessonAstronomyState extends State<lessonAstronomy> {
  @override
