...
class lessonEnvironment extends StatefulWidget {
  @override
  _lessonEnvironmentState createState() => _lessonEnvironmentState();
}

class _lessonEnvironmentState extends State<lessonEnvironment> {
  int score = 0;
  get() async {
